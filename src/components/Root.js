...
class Root extends Component {
  constructor(){
    ...
    this.state = {
      ...
      latex : null,
      singleEntry : true,
      firstEntryOfNumericalExpression : true,
  ...
  handlingNumericalExpression(index,inputExp,storyCardIndex,numericalExpressionIndex) {
    this.initstoryCardObj();
    const storyCardObjArraytemp= Object.assign({},this.state.storyCardObj[storyCardIndex]);
    storyCardObjArraytemp.inputListIndex = index;
    storyCardObjArraytemp.expVariable = null;
    ...
    this.setState({storyCardObj:storyCardObjtemp},
      () =>{
        ...
        numericalExpressionArrayTemp.inputListIndex = index;
  ...
  handlingVariableAssignedNumericalExpression(index,inputExp,storyCardIndex,variable,SliderStatus) {
    var sliderMinVal = -10;
    var sliderMaxVal = 10;
  ...
  handleSwitchCases(Cases,inputExp,index) {
    ...
    switch (Cases) {
      case 0:
            ...
            if(this.state.numericalExpressionArray.length !== undefined) {
              this.state.numericalExpressionArray.filter((item) => {
                if(item.inputListIndex !== index) {
                this.handlingNumericalExpression(index,inputExp,this.state.storyCardObj.length,this.state.numericalExpressionArray.length);
                }
              })
              this.state.numericalExpressionArray.filter((item,numericalExpressionArrayIndex) => {
                if(item.inputListIndex === index) {
                  this.handlingNumericalExpression(index,inputExp,numericalExpressionArrayIndex,numericalExpressionArrayIndex);
                }
              })
            }
            else {
              this.handlingNumericalExpression(index,inputExp,this.state.storyCardObj.length,this.state.storyCardObj.length);
              }
          break;
      ...
      case 1:
            ...
            if(this.state.scope[this.state.words[0]] === undefined) {
              this.initstoryCardObj();
              this.handlingVariableAssignedNumericalExpression(index,inputExp,this.state.storyCardObj.length,this.state.words[0],SliderStatus);
            }
            else { 
              if(numericalExpression.test(this.state.words[1])) {
                this.state.storyCardObj.filter((item,storyCardIndex) => {
                  if(this.state.words[0] === item.expVariable) {
                    ...
                    this.handlingVariableAssignedNumericalExpression(index,inputExp,storyCardIndex,this.state.words[0],SliderStatus);
                  }
                });
              }
            }
                          ...
                          if(variables.test(h)){
                            ...
                            this.setState({storyCardObj:storyCardObjtemp},
                              () => {
                                ...
                                this.setState({storyCardObj:storyCardObjtemp},
                                  () => {
                                    console.log("scope 2nd",this.state.scope)
                                    console.log("storyCardObj",this.state.storyCardObj)
                            ...
                            this.setState({storyCardObj:storyCardObjtemp},
                              () =>{
                                console.log("scope 3rd",this.state.scope)
                                console.log("storyCardObj",this.state.storyCardObj)
                  ...
                  if(sp != null) {
                    ...
                    console.log(sp)
                      ...
                      if(variables.test(h)){
                        ...
                        this.setState({storyCardObj:storyCardObjtemp},
                          () => {
                            console.log("scope 4th",this.state.scope)
                            console.log("storyCardObj",this.state.storyCardObj)
                      ...
                      this.state.storyCardObj.filter((item,storyCardIndex) => {
                        if(item.expVariable === this.state.words[0]) {
                          ...
                          this.setState({storyCardObj:storyCardObjtemp},
                            () =>{
                              console.log("scope 5th",this.state.scope)
                              console.log("storyCardObj",this.state.storyCardObj)
    ...
    this.setState(
      { countField: this.state.countField + 1 ,
        ...
        () => {
          ...
          this.setState({firstEntryOfNumericalExpression : true}); 
        })
  };
  ...
  updateScope(sliderVariable,sliderValue) {
    ...
    this.setState({scope:scopeTemp},
      () =>{
        console.log("stroycaard,",this.state.storyCardObj)
        this.state.storyCardObj.filter((items,storyCardIndex) => {
        console.log("items,",items.expVariable)
  ...
  deleteInput(index,e) {
    ...
    this.setState({inputList:inputListTemp},
      () => {
        this.state.storyCardObj.filter((item,storyCardIndex) => {
          if(item.inputListIndex === index && item.expVariable === null) {
            const storyCardObjArraytemp= Object.assign([],this.state.storyCardObj);
...
sliderIntervalOnClick(index,sliderMinOrMax) {
        ...
        if(this.state.storyCardObj.length > 0 ) {
        // this.state.storyCardObj.filter((item) => {
        // if(e.target.value !== item.expVariable) {
        // console.log("eee")
        const arrayobj= Object.assign({},this.state.inputList[index]);
        arrayobj.inputValue = e.target.value;
